...
|Remove from Cart|User removes anything from their cart|
|Cart Page|User views their cart|
|Customer Information ( Only Available on Shopify Plus )|Triggers on the “Customer Information” section of the Checkout funnel|
|Shipping ( Only Available on Shopify Plus )|Triggers on the “Shipping” section of the Checkout funnel|
|Add Payment Info ( Only Available on Shopify Plus )|Triggers on the “Add Payment” section of the Checkout funnel|
